...
export default function BookManage() {
  ...
  const handleSearch = () => {
    ...
    if (selectedBookId.trim()) {
      navigate(
        `/style/role/startStory?query=${encodeURIComponent(selectedBookId)}`,
      );
    } else {
      alert("請選擇故事書");
    }
    ...
    <>
      ...
      <div className="container-fluid">
        <div className="header">
          <div className="header-content">WisperTales</div>
            ...
            <div className="mx-auto">
              <div className="input-group">
                ...
                <div className="input-group-append">
                  <button onClick={handleSearch} className="button-submit AAA">
                    選擇
                  </button>
                </div>
              </div>
              ...
              {loading ? (
                ...
                options.map((option) => (
                  <div
                    ...
                    onClick={() =>
                      handleOptionClick(option.bookName, option.bookId)
                    }
