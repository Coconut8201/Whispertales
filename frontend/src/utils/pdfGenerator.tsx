...
const StoryPDFDocument: React.FC<{
  ...
  storyLines: string[];
  showZhuyin?: boolean;
}> = ({ data, storyLines, showZhuyin = false }) => (
  <Document>
    {/* 封面頁 */}
        ...
        <Page key={index} size="A4" style={pdfStyles.page}>
          <View style={pdfStyles.fullPage}>
            ...
            <View style={pdfStyles.textOverlay}>
              <Text style={pdfStyles.storyText}>
                {line}
              </Text>
            </View>
          </View>
...
export class PDFGenerator {
  ...
  static async generatePDF(
    ...
    const pdfDocument = <StoryPDFDocument 
      data={data} 
   ...
   * Base64 轉 Blob
   */
  private static base64ToBlob(base64: string, type: string = 'image/png'): Blob {
