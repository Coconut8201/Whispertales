...
const InstructionData: _Instruction[] = [
  {
    title: "✈登入或註冊",
    imageURL: "https://i.imgur.com/f7tef0p.jpg",
    imageAlt: "登入畫面",
    desc: _login,
  },
  {
    title: "✘登出",
    imageURL: "https://i.imgur.com/GpVW5ef.jpg",
    imageAlt: "登出畫面",
    desc: _logout,
  },
  {
    title: "⎚描述文本並生成圖片",
    imageURL: "https://i.imgur.com/ZLn93ae.jpg",
    imageAlt: "輸入文本並生成圖片",
    desc: _text_and_gen,
  },
  {
    title: "☼功能介紹",
    imageURL: "https://i.imgur.com/CNO9tHn.jpg",
    imageAlt: "輸入文本並生成圖片",
    desc: _features,
  },
  ...
  {
    title: "⇩下載圖片",
    imageURL: "https://i.imgur.com/YYT08ns.jpg",
    imageAlt: "輸入文本並生成圖片",
    desc: _pic_download,
  },
